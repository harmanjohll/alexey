...
!   used for a grand canonical move
...
!       if w1 or w2 selected for switch 
        if (w1.eq.catom1.or.w2.eq.catom1) then
...
101           if (w1.eq.catom1.or.w2.eq.catom1.or.
     &            pick.eq.1) then
...
!             At least one of w1, w2, w3 switched
102           if (w1.eq.catom1.or.w2.eq.catom1.or.
     &            pick.eq.1) then
...
!             At least one of w1, w2, w3 switched
201           if (w1.eq.catom1.or.w2.eq.catom1.or.
     &            pick.eq.1) then
...
!             At least one of w1, w2, w3 switched
202           if (w1.eq.catom1.or.w2.eq.catom1.or.
     &            pick.eq.1) then
...
!        resetting the species of catom1
         satom(catom1)=s1i
