...
var REPORT_ITEMS = [
  // ── Pre-checked by default. Spans tuned for the user-approved hero-pair
  //    layout: lattice + roughness on row 1 (each span 3) so the lattice
  //    fills its native 3.33:1 aspect with no horizontal gutter. Row 4
  //    distributions are taller (280 nat) for cleaner small charts. ──
  { key: 'lattice',    label: 'Lattice Cross-Section',          group: 'default', kind: 'canvas',
    canvasId: 'latticeCanvas', span: 3, natH: 260 },
  ...
  { key: 'hist',       label: 'Height Distribution (current)',  group: 'optional', kind: 'canvas',
    canvasId: 'histChart', span: 1, natH: 280 },
  ...
  { key: 'conc',       label: 'Concentration Profile',          group: 'optional', kind: 'canvas',
    canvasId: 'concChart', span: 1, natH: 280 },
